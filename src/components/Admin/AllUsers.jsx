...
//       // 2. Find all chats where the user is a participant
...
//       // 3. For each chat, delete the chat and its messages
  ...
  const toggleBanStatus = async () => {
    ...
    try {
      ...
      await updateDoc(userRef, {
        ...
        banReason: isBanning ? banReason : null,
        bannedAt: isBanning ? new Date() : null,
        authDisabled: isBanning // This flag should be checked during authentication
      });
