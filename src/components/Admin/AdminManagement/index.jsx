...
import AddAdminForm from "./AddAdminForm";
import RemoveAdminModal from "./RemoveAdminModal";
import ActionHistoryModal from "./ActionHistoryModal"; // Added import
import { useCurrentAdmin, useAdmins } from "../AdminUtils/adminHooks";
import { addAdmin, removeAdmin } from "../AdminUtils/adminFunctions";
import "./AdminManagement.css";
...
const AdminManagement = () => {
  ...
  const [selectedAdmin, setSelectedAdmin] = useState(null);
  const [combinedError, setCombinedError] = useState(null);
  const [showActionModal, setShowActionModal] = useState(false); // Added state
  const [selectedAdminForActions, setSelectedAdminForActions] = useState(null); // Added state
      ...
      <main className="admin-main">
        ...
        {loading ? (
          ...
          <AdminTable 
            ...
            onViewActions={(admin) => {
              setSelectedAdminForActions(admin);
        ...
        {showActionModal && (
          <ActionHistoryModal
            admin={selectedAdminForActions}
            onClose={() => {
              setShowActionModal(false);
              setSelectedAdminForActions(null);
            }}
          />
        )}
      </main>
