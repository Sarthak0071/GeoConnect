...
//       setCurrentLocation({ lat: parseFloat(latitude), lng: parseFloat(longitude) });
//       reverseGeocode(latitude, longitude);
//       fetchTouristPlacesFromGenAI(latitude, longitude);
//     } catch (err) {
//       console.error("Error fetching IP-based location: ", err);
//     }
//   };

//   // Fetch tourist places using Google Generative AI
//   const fetchTouristPlacesFromGenAI = async (lat, lng) => {
//     try {
//       const response = await fetch(`http://localhost:5000/api/genai-places?lat=${lat}&lng=${lng}`);
//       const data = await response.json();

//       if (data.places) {
//         setTouristPlaces(data.places.map((name, index) => ({ name, location: null, index })));
//       } else {
//         console.error("No places returned by Generative AI");
//       }
//     } catch (err) {
//       console.error("Error fetching tourist places from Generative AI: ", err);
//     }
//   };
...
const Home = () => {
  ...
  // Fetch tourist places from the backend
